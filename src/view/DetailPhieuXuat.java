...
public class DetailPhieuXuat extends JFrame {
	...
	private String[] columName = { "ID đơn xuất", "ID sản phẩm", "Tên sản phẩm", "Bảo hành", "Số lượng ", "Đơn giá" };
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DetailPhieuXuat frame = new DetailPhieuXuat();
					frame.setLocationRelativeTo(null);
					frame.setResizable(false);
					frame.setTitle("Chi tiết đơn hàng " + PhieuXuatForm.getPhieuXuatSelect().getIdPhieu());
...
//				table.getColumnModel().getColumn(2).setCellRenderer(renderCenter);
	...
	public void setDefaultTable() {
		...
		loadDataToTable(
				ChiTietPhieuXuatDAO.getInstance().selectAllByID(PhieuXuatForm.getPhieuXuatSelect().getIdPhieu()));
	}

	public DetailPhieuXuat() {
		...
		tabbedPane.addTab("Chi tiết phiếu xuất",
				new ImageIcon(DetailPhieuXuat.class.getResource("/icon/icons8-about-12.png")), panel, null);
		panel.setLayout(null);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.TRAILING);
		lblNewLabel_1.setIcon(new ImageIcon(DetailPhieuXuat.class.getResource("/icon/icons8-search-24.png")));
		...
		btnNewButton.setIcon(new ImageIcon(DetailPhieuXuat.class.getResource("/icon/icons8-details-24.png")));
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					if (saveFile != null) {
						...
						Sheet sheet = wb.createSheet("Phiếu xuất");
		...
		btnNewButton_1.setIcon(new ImageIcon(DetailPhieuXuat.class.getResource("/icon/icons8-export-excel-24.png")));
		...
		tabbedPane.addTab("Hóa đơn", new ImageIcon(DetailPhieuXuat.class.getResource("/icon/icons8-bill-12.png")),
				panel_1, null);
		...
		btnNewButton_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				xuatpdf.taoPhieuXuat(PhieuXuatForm.getPhieuXuatSelect().getIdPhieu());
			}
		});
	...
	private ArrayList<ChiTietPhieu> soLuongTang() {
		ArrayList<ChiTietPhieu> list = ChiTietPhieuXuatDAO.getInstance()
				.selectAllByID(PhieuXuatForm.getPhieuXuatSelect().getIdPhieu());
	...
	private ChiTietPhieu getChiTietPhieuSelect() {
		return ChiTietPhieuXuatDAO.getInstance().selectAllByID(PhieuXuatForm.getPhieuXuatSelect().getIdPhieu())
